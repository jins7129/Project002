...
public class KakaoResponseDto {
	...
	public KakaoAmountDto getAmount() {
		return amount;
	}
	public void setAmount(KakaoAmountDto amount) {
		this.amount = amount;
	}
	public KakaoCardDto getCard_info() {
		return card_info;
	}
	public void setCard_info(KakaoCardDto card_info) {
	...
	public String toString() {
		return "KakaoResponseDto [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid + ", partner_order_id="
