...
<body>
	...
	<div align="center" >
		<img src="resources/file/profilePhoto/${loginInfo.userId}.${loginInfo.userImgpath}" />
		<table>
			<tr>
				<td>이름 : </td>
			...
			<tr>
				<td colspan="3" align="right">
					<input id="btnUpdate" type="button" value="수정하기" onclick="location.href='mypage_update.do'"/>
				</td>
			</tr>
